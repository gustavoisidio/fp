import Data.List
--Um conjunto será representado como uma lista ordenada de elementos sem repetições
newtype Set a = Set [a]
...
-- Esta definição se baseia na noção de ordem, as listas não são arbitrárias
memSet :: Ord a => Set a -> a -> Bool
memSet (Set []) y = False
memSet (Set (x:xs)) y
    |  x<y = memSet (Set xs) y |  x==y = True
    |  otherwise = False
...
-- A função showSet imprime cada elemento com conjunto, um por linha, usando a função f que transforma cada um dos elementos em uma string
